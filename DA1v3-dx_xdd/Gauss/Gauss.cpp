...
int main() {
    ifstream inFile("C:\\Users\\Admin\\OneDrive - Hanoi University of Science and Technology\\MI1 HUST\\DA1\\DA1v3-dx_xdd\\input.txt");
    ofstream outFile("C:\\Users\\Admin\\OneDrive - Hanoi University of Science and Technology\\MI1 HUST\\DA1\\DA1v3-dx_xdd\\output.txt");
    int n;
    inFile >> n;
    ...
    outFile << "Tổng thời gian 100 lần chạy: " << fixed << setprecision(3) << total_time/1000.0 << " s" << endl;
