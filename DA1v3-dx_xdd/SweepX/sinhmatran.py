...
if __name__ == "__main__":
    m, n = 25, 20  # bạn có thể thay đổi
    X, A = sinh_ma_tran_nguyen(m, n, positive_definite=True, seed=42)
    ghi_vao_file(X, r"C:\Users\Admin\OneDrive - Hanoi University of Science and Technology\MI1 HUST\DA1\DA1v3-dx_xdd\SweepX\inputX.txt")
