...
def ghi_vao_file(X, filename="input.txt"):
    m, n = X.shape
...
if __name__ == "__main__":
    m, n = 100, 50  # bạn có thể thay đổi
    X, A = sinh_ma_tran_nguyen(m, n, positive_definite=True, seed=42)
    ghi_vao_file(X, r"C:\Users\Admin\OneDrive - Hanoi University of Science and Technology\MI1 HUST\DA1\DA1v3\SweepX\input.txt")
    print("Đã ghi ma trận X (số nguyên) vào file input.txt")
